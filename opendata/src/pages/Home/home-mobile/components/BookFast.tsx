  ...
  return (
    <div className="w-full flex flex-col gap-4  p-4 rounded-lg border bg-accent">
      ...
      <div className="flex flex-col items-center justify-center gap-2">
        <Input className="text-sm" type="text" placeholder="Adınız" />
        <Input className="text-sm" type="text" placeholder="Soyadınız" />
        <Input className="text-sm" type="text" placeholder="Telefon Numarası" />
        <Button className="w-full text-sm">Gönder</Button>
      </div>
